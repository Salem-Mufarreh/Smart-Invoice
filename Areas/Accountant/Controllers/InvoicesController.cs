...
namespace Smart_Invoice.Areas.Accountant.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,InvoiceNumber,InvoiceDate,DueDate,TotalAmount,CurrencyCode,PaymentStatus,PaymentDate,ExchangeRate,EffectiveDate,TaxPercentage,TaxTotal")] Invoice invoice)
        {
