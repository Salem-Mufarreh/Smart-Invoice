...
function GenerateItemBlock() {
        ...
        // Create the HTML code for the item with unique IDs
        var itemHtml = `
        <div class="form-floating col-md-6" style="margin-bottom:0.5em; margin-right:30px">
        <input class="form-control " id="${productID}" name="${productID}" aria-required="true" value=""  required/>
        ...
        <button class="btn btn-danger remove-product-btn col-md-2" id="@product.Name" data-item-id="Block_${ItemNumber}" style="width:fit-content"> 
      ...
      <hr>
        `;
    var container = document.getElementById("generatedItemBlock");
    // Create a new div element and set its inner HTML to the item HTML code
    var newItem = document.createElement("div");
    newItem.classList.add("row");
    newItem.classList.add("g-3");
    newItem.classList.add("Block_" + ItemNumber);
