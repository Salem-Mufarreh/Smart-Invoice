...
namespace Smart_Invoice.Data.Migrations
{
    ...
    [Migration("20230501124358_added Customer Normilization v2 ")]
    partial class addedCustomerNormilizationv2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smart_Invoice.Models.UtilityInvoice", b =>
                {
                    ...
                    b.Property<string>("Incoive_Companay")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Smart_Invoice.Models.UtilityInvoice", b =>
                {
                    b.HasOne("Smart_Invoice.Models.Customer", "Company_Id")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
